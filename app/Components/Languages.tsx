...
function SecondPage() {
    return (
        <div id='languages'>
            <main className="px-4 pb-60" data-aos="zoom-in-up" data-aos-duration="1000">
                <div
                    className="text-center shadow-2xl p-6 rounded-xl mb-40 mt-24 dark:bg-white flex flex-1 mx-auto flex-col">
...
function LanguageCard({title, image} : LanguageCardProps) {
    return (
        <div
            className="flex flex-col items-center justify-center shadow-md rounded-lg hover:scale-105 transition-transform duration-200 ease-in p-4">
